    ...
    <html lang="bs">
      <body style={{ margin: 0, fontFamily: "system-ui, sans-serif", background: "#0f0f0f", color: "#e5e5e5", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", padding: 24, maxWidth: 480 }}>
          <h1 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Nešto nije u redu</h1>
          <p style={{ fontSize: 14, opacity: 0.85, marginBottom: 20 }}>{error?.message ?? "Došlo je do greške."}</p>
          <button
            type="button"
            onClick={() => reset()}
            style={{
