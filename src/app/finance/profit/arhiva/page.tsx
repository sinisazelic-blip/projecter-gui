    ...
    <div className="container profitPageWrap">
      <style>{`
        ...
        @media print {
          ...
          .profitPageWrap .printFooter { display: flex !important; }
          ...
          <div className="topInner">
            <div className="topRow">
              <div className="brandWrap">
                ...
                <div>
                  <div className="brandTitle">Arhiva (staging)</div>
                  <div className="brandSub">Vrijednost projekta − ukupno troškovi po mjesecu i godini (stg_master_finansije)</div>
                </div>
              </div>
              <ProfitTopActions
