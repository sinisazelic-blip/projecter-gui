...
- **Detalji:** **FLUXA-V1-FISKAL-NAPOMENE.md** (poglavlja 2 i dalje).
...
| 4.3 | **Dokumentacija / User manual** | ✅ Završeno. Uputstvo u aplikaciji (/uputstvo, sr+en, screenshoti) + first-run Fluxa onboarding (uvodna tura). V. plan 2.5. |
...
| 4.7 | **Poslovanje Studio TAF** | ✅ Odluke donesene. Fluxa = autorsko djelo S. Zelića; EU partner za licenciranje. V. plan 2.8, **arhiva/POSLOVANJE-FLUXA-LICENCE-ODLUKE.md**. |
| 4.8 | **Uplata → produženje licence (portal ↔ Master-Fluxa)** | ✅ Završeno. Endpoint POST /api/public/licence-extend; Fluxa portal (DO) nakon PayPal uplate zove Master-Fluxu; svi zakupi/plaćanja preko portala. V. **PLAN_PAYMENT_EXTEND_LICENCE.md**. |

**Ostaje za implementaciju (2 stavke):** Fiskalni uređaj (2.1), Export prazne SQL baze (2.7).
...
- **Detalji:** **PLAN_DEPLOY_I_INSTALACIJA.md** (koraci 1.1–1.3, varijable okruženja, web server).
